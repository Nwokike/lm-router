    ...
    return ft.Column(
        ...
        controls=[
            ...
            ft.NavigationBar(
                ...
                # Material 3's default bar is 80px tall, which reads as a
                # massive slab on a phone. Sherlock keeps it compact; match
                # that so the app does not look like a default Flet shell.
                height=64,
